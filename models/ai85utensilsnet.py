...
###################################################################################################
"""
Utensils (Spoon / knife) classification network for AI85
"""
from torch import nn
import ai8x

class AI85UtensilsNet(nn.Module):
    """
    Define CNN model for image classification (2 classes: spoon, knife).
    """
...
def ai85utensilsnet(pretrained=False, **kwargs):
    """
    Constructs a AI85UtensilsNet model.
    """
    assert not pretrained
    return AI85UtensilsNet(**kwargs)

models = [
    {
        'name': 'ai85utensilsnet',
        'min_input': 1,
        'dim': 2,
    },
]
