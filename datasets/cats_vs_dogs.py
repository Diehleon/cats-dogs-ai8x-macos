...
class CatsvsDogs(Dataset):
    ...
    Root directory layout assumed (relative to your --data path):
        cats_vs_dogs/
            train/
                cats/
                dogs/
            test/   # or use 'test' split as validation
                cats/
                dogs/
    ...
    def __init__(self, root_dir, d_type, transform=None,
        ...
        # Expect root_dir like ".../data/cats_vs_dogs"
    ...
    def __print_manual_instructions(self):
        ...
        print("  <data_root>/cats_vs_dogs/train/cats")
        print("  <data_root>/cats_vs_dogs/train/dogs")
        print("  <data_root>/cats_vs_dogs/test/cats")
        print("  <data_root>/cats_vs_dogs/test/dogs")
...
def get_catsvsdogs_dataset(data, load_train, load_test):
    ...
    test_ds = None
    if load_train:
        train_ds = CatsvsDogs(root_dir=data_dir, d_type='train',
                              transform=transform, augment_data=True)
    if load_test:
        test_ds = CatsvsDogs(root_dir=data_dir, d_type='test',
